  ...
  <div v-if="govnVC">
    ...
    >
      ...
      <span
        ...
        @click.prevent="displayTrustConsent"
      > {{ requestOrigin }} </span>
    </div>
    ...
    <div :hidden="hideTrustConsent">
      <md-card>
        <md-card-header style="background-color: #eaeaea; margin: 10px;">
          <md-card-header-text>
            ...
            <div class="md-subhead">
              {{ govnVC.credentialSubject.description }}
            </div>
          </md-card-header-text>
        ...
        <md-subheader>
          ...
          >As per <b style="font-size: 16px">{{ govnVC.credentialSubject.name }}</b> rules, issuers should prove
          ...
          <span
            v-else
            style="margin-top: 10px"
          >As per <b style="font-size: 16px">{{ govnVC.credentialSubject.name }}</b> rules, verifiers should prove
      ...
      <md-card>
        ...
        <md-subheader>
          <span
            v-if="issuer"
            style="margin-top: 10px"
          >Issuers should prove they're accredited by trusted governance authority before issuing credentials. The current issuer,
          ...
          <span
            v-else
            style="margin-top: 10px"
          >Verifiers should prove they're accredited by trusted governance authority before asking for your credentials. The current verifier,
            <b style="font-size: 14px;color: #d73a49;">{{ requestOrigin }}</b>, has not proven they are accredited by a trusted governance authority.</span>
        </md-subheader>
