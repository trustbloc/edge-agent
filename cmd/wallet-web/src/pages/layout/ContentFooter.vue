...
<template>
  <div class="w-full mx-6 px-15 py-6 text-center">
    <div class="text-neutrals-medium mx-auto md:block hidden text-center">
       © {{ date }} TrustBloc ･ {{ $t("ContentFooter.privacyPolicy") }} ･ {{ $t("ContentFooter.terms") }}  ･
    ...
    <div class="text-neutrals-medium md:hidden block">
      <ul class="list-inside">
        <li><span class="whitespace-nowrap">{{ $t("ContentFooter.privacyPolicy") }}</span> ･ <span class="whitespace-nowrap">{{ $t("ContentFooter.terms") }}</span></li>
