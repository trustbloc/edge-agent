...
<template>
  <div
    v-if="loading"
    class="w-screen"
    style="margin-top: 20%; height: 200px;"
  >
  ...
  <div
    v-else
    class="md-layout w-screen flex flex-col items-center"
  >
      ...
      <div v-if="!credentialWarning.length">
        <div v-if="credsFound">
          <p id="result-header-1">
            <md-icon style="color: #0E9A00; height: 40px;font-size: 20px !important;">
              done
            </md-icon>
