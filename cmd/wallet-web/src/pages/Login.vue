    ...
    <div class="px-4 py-24">
      ...
      >
        <div class="flex justify-between items-center">
          ...
          >
          <a
            class="font-semibold text-white text-2xl lg:text-4xl tracking-tight"
            ...
            <div
                ...
                <div>
                    <div class="hidden md:block  text-lg">
                        <a href="#"
                           class="inline-block py-1 md:py-4 text-gray-100 mr-6 hover:text-gray-500 font-inline">Features</a>
                        <a href="#"
                           class="inline-block py-1 md:py-4 text-gray-100 font-inline hover:text-gray-500 mr-6">Security</a>
                ...
                <div class="hidden md:block">
                    ...
                    <a href="#"
                       class="text-lg py-3 px-12 border module-border-wrap text-gray-100 hover:shadow-lg hover:text-black">Get
                        Started</a>
                </div>
            </div>
        </div>
        <div>
          <div class="hidden md:block  text-lg">
            <a
              href="#"
              class="inline-block py-1 md:py-4 text-gray-100 mr-6 hover:text-gray-500 font-inline"
            >Features</a>
            <a
              href="#"
              class="inline-block py-1 md:py-4 text-gray-100 font-inline hover:text-gray-500 mr-6"
            >Security</a>
            <a
              href="#"
        ...
        <div class="hidden md:block">
          <a
            href="#"
            class="inline-block py-1 md:py-4 text-gray-100 hover:text-gray-500 mr-6"
          />
          <a
            href="#"
            class="text-lg py-3 px-12 border module-border-wrap text-gray-100 hover:shadow-lg hover:text-black"
          >Get
            Started</a>
        </div>
      </div>
        ...
        <div class="md:max-w-6xl md:mx-auto">
          <div class="md:flex md:flex-wrap md:justify-center">
            ...
            <div class="md:px-24 relative">
              <div class="hidden md:block">
                <img
                  class="object-scale-down h-84 w-full"
                  src="@/assets/img/home_wallet.png"
                  alt=""
                >
              </div>
            </div>
      ...
      <footer class="footer footer-gradient relative py-24  border-b-2 border-blue-700">
        <div class="container mx-auto px-6 border-gray-300 flex flex-col items-center">
          <div class="sm:w-2/3 py-16">
            <p class="text-sm text-white text-center font-light  mb-2">
