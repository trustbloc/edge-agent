    ...
    <md-dialog :md-active.sync="dialog">
          ...
          <div class="md-layout-item">
            <div v-if="dialogContent === 'acceptRequestForm'">
              <md-field>
                ...
                <md-textarea
                  v-model="issueCredential"
                  required
                />
              </md-field>
              <span
                v-if="acceptRequestError"
                class="error"
              >{{ acceptRequestError }}</span>
            </div>
            <div v-else-if="dialogContent === 'acceptCredentialForm'">
              <md-field>
                <label>Credential names coma separated e.g name1,name2</label>
                <md-textarea
                  v-model="issueCredentialNames"
                  required
                />
              </md-field>
              <span
                v-if="acceptCredentialError"
                class="error"
              >{{ acceptCredentialError }}</span>
            </div>
      ...
      <md-dialog-actions v-if="dialogContent === 'acceptRequestForm'">
        <md-button
          ...
          @click="acceptRequest(selectedAction,true)"
        >
          Send
        </md-button>
      </md-dialog-actions>
          ...
          <md-card class="md-card-plain">
            ...
            <md-card-content style="background-color: white;">
              ...
              <div style="display: flow-root">
                ...
                >{{ sendOfferError }}</span>
                <span
                  v-if="sendOfferSuccess"
                  class="success"
                >{{ sendOfferSuccess }}</span>
                <md-button
